...
interface ProduitsEditProps {
    produit: Produit;
    sousCategories: SousCategorie[];
}

export default function ProduitsEdit({ produit, sousCategories }: ProduitsEditProps) {
    ...
    const { data, setData, errors, put, processing } = useForm({
        ...
        sous_categorie_id: produit.sous_categorie_id.toString(),
    });
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground">
                                Modifier les informations de {produit.nom}
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex justify-end space-x-4">
                                <Button variant="outline" asChild>
                                    <Link href={`/produits/${produit.id}`}>Annuler</Link>
                                </Button>
