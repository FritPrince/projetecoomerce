...
interface CouponsEditProps {
    coupon: Coupon;
}

export default function CouponsEdit({ coupon }: CouponsEditProps) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`Modifier le Coupon: ${coupon.name}`} />
            <div className="flex h-full flex-1 flex-col gap-6 p-6">
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold">Modifier le Coupon</h1>
                            <p className="text-muted-foreground">
                                Mettre à jour les informations du coupon.
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex justify-end space-x-4">
                                ...
                                <Button type="submit" disabled={processing}>
                                    ...
                                    {processing ? 'Mise à jour...' : 'Mettre à jour le coupon'}
                                </Button>
                            </div>
                        </form>
                    </CardContent>
